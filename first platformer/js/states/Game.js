...
ZPlat.GameState = {
  ...
  init: function(level) {    
    ...
    //making sure that we start in level 1
  ...
  update: function() {    
    ...
    //collisionbetween the player,enemies and the collision layer  
  ...
  loadLevel: function(){  
    //declarating a tile map that is going to be used as a  
    this.map = this.add.tilemap(this.currentLevel);
      
    //join the tile images to tilemap data
    ...
    //sending a background to fare back
    this.game.world.sendToBack(this.backgroundLayer);
      
    //collision layer should be collisonLayer
    ...
    //create the goal
    var goalArr = this.findObjectsByGid('148',this.map, 'objectsLayer');
    ...
    //create player
    var playerArr = this.findObjectsByGid('147', this.map, 'objectsLayer')
  ...
  createOnscreenControls: function(){
    ...
    findObjectsByGid: function(Gid, tilemap, layer){
        var result = [];
    ...
    createEnemies: function(){
        var enemyArr = this.findObjectsByGid('146', this.map, 'objectsLayer')
        var enemy;
